...
public class SkullRendererDefault implements ISkullRenderer
{
	/** 最大のサイズは1.0Fと想定 */
	...
	public SkullRendererDefault setSize(float x, float y, float z)
	{
		this.xSize = x;
		this.ySize = y;
		this.zSize = z;
	...
	public SkullRendererDefault setAlpha(boolean flag)
	{
		this.isAlpha = flag;
		return this;
	}
